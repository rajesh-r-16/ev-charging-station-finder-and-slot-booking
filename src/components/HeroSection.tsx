...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Navigation Header */}
      <header className="absolute top-0 left-0 right-0 z-20 bg-background/90 backdrop-blur-md border-b shadow-lg">
        <div className="container mx-auto px-4 py-6 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Zap className="h-7 w-7 text-primary" />
            <span className="text-2xl font-bold">EVCharger</span>
          </div>
            ...
            {user ? (
              ...
              <>
                <Button 
                  ...
                  className="flex items-center gap-2 text-lg px-8 py-3 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-r from-primary to-electric-blue hover:from-primary/90 hover:to-electric-blue/90"
                >
