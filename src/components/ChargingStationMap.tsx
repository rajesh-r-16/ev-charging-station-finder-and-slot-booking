...
const mockStations = [
  {
    id: 1,
    name: "Tata Power EV Station - Connaught Place",
  ...
  {
    id: 2,
    name: "EESL Charging Station - Select City Walk",
  ...
  {
    id: 3,
    name: "Fortum Charge Hub - IGI Airport",
    address: "IGI Airport T3, New Delhi",
    distance: "2.8 km",
    availableSlots: 0,
    totalSlots: 12,
