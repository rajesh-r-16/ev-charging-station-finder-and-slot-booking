...
const RoutePlanner = () => {
  ...
  const calculateRoutes = async () => {
    ...
    try {
      ...
      // 1. Gets route from Google Maps/OSRM
      // 2. Calculates energy consumption based on vehicle profile
      // 3. Finds optimal charging stops
      // 4. Calculates costs and carbon for each option
    ...
    <div className="space-y-6">
      <Card className="border-0 shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Plan your journey with guaranteed SoC targets and optimized charging stops
          </CardDescription>
        </CardHeader>
            ...
            <div className="space-y-4">
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-sm text-muted-foreground">
                          {route.chargingStops} charging stops
                        </span>
                      </div>
              ...
              {selectedRoute && (
                <Button className="w-full">
                  ...
                  Start Navigation with {selectedRoute.chargingStops} Charging Stops
                </Button>
              )}
            </div>
          )}
